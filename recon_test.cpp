...
int main(int argc, char** argv)
{
    ...
    Mat img1 = imread("/home/long/data/scale/right_rect/0001.png", 0);
    Mat img2 = imread("/home/long/data/scale/left_rect/0001.png", 0);
Mat img1c = imread("/home/long/data/scale/right_rect/0001.png", 1);
    Mat disp, disp8;

    int64 t = getTickCount();

    disp = compute_disparity_BM(img1,img2);
    //disp = compute_disparity_ELAS(img1,img2);

    t = getTickCount() - t;

    printf("Stereo Time elapsed: %fms\n", t*1000/getTickFrequency());
